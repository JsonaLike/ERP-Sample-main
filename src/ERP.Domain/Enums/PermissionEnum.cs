...
namespace ERP.Domain.Enums
{
    public enum PermissionEnum
    {
        ...
        [Description("View InventoryItem:InventoryItems")]
        InventoryItemView = 41,
        [Description("Edit InventoryItem:InventoryItems")]
        InventoryItemEdit = 42,
        [Description("Add InventoryItem:InventoryItems")]
        InventoryItemAdd = 43,
        [Description("Delete InventoryItem:InventoryItems")]
        InventoryItemDelete = 44,

         [Description("View Vendor:Vendors")]
        VendorView = 45,
        [Description("Edit Vendor:Vendors")]
        VendorEdit = 46,
        [Description("Add Vendor:Vendors")]
        VendorAdd = 47,
        [Description("Delete Vendor:Vendors")]
        VendorDelete = 48,

        [Description("View PurchaseOrder:PurchaseOrders")]
        PurchaseOrderView = 49,
        [Description("Edit PurchaseOrder:PurchaseOrders")]
        PurchaseOrderEdit = 50,
        [Description("Add PurchaseOrder:PurchaseOrders")]
        PurchaseOrderAdd = 51,
        [Description("Delete PurchaseOrder:PurchaseOrders")]
