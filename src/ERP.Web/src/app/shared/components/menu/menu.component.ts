...
items!: MenuItem[];
  ...
  getMenu() {
    ...
    },
    {
      ...
      , {
        label: 'Inventory Item', icon: 'fa fa-box', routerLink: '/app/inventory/list',
        visible: this.permissionService.hasPermission(PermissionEnum.UserView)
      }
      , {
        label: 'Vendors', icon: 'fa fa-box', routerLink: '/app/vendors/list',
        visible: this.permissionService.hasPermission(PermissionEnum.UserView)
      } 
      , {
        label: 'Purchase Orders', icon: 'fa fa-box', routerLink: '/app/purchase-orders/list',
        visible: this.permissionService.hasPermission(PermissionEnum.UserView)
      }
    ]
    },
