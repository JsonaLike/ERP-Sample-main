...
const routes: Routes = [
  {
    ...
    {
      path: 'inventory',
      loadChildren: () => import('./modules/inventory-items/Inventory.module').then(m => m.InventoryModule)
    }, {
      path: 'roles',
      ...
      path: 'vendors',
      loadChildren: () => import('./modules/vendors/Vendor.module').then(m => m.VendorModule)
    }, {
      path: 'purchase-orders',
      loadChildren: () => import('./modules/purchase-orders/PurchaseOrder.module').then(m => m.PurchaseOrderModule)
    }]
  }, {
    path: '',
    redirectTo: 'auth',
